...
## Network Firewall 개요 { #network-firewall-overview }
...
<a id="1-project"></a>
### 1개의 프로젝트 { #1-project }
![](../static/images/26.07.28/1.overview/architecture1.png){ height="70%" }
...
### 다른 리전 간 프로젝트 { #projects-between-different-regions }
![](../static/images/26.07.28/1.overview/architecture3.png){ width="100%" height="70%" }


<a id="2-spoke-vpcs-in-1-project"></a>
### 1개의 프로젝트 내 2개의 Spoke VPC { #2-spoke-vpcs-in-1-project }
![](../static/images/26.07.28/1.overview/architecture4.png){ width="100%" height="70%" }


<a id="multiple-subnets-in-a-single-vpc"></a>
### 1개의 VPC 내 여러 개의 서브넷 { #multiple-subnets-in-a-single-vpc }
![](../static/images/26.07.28/1.overview/architecturer5.png){ width="100%" height="50%" }
...
!!! tip "알아두기"
    ...
    * 다른 리전의 프로젝트 환경에서는 같은 프로젝트만 구성 가능합니다. 자세한 내용은 [사용자 가이드](/Network/Peering%20Gateway/ko/console-guide/)를 참고하세요.
